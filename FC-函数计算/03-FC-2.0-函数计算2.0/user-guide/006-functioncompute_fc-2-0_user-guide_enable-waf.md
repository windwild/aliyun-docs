...
[首页](https://help.aliyun.com/) [函数计算](https://help.aliyun.com/zh/functioncompute/)[函数计算 FC 2.0（文档已停止维护）](https://help.aliyun.com/zh/functioncompute/fc-2-0/)[操作指南](https://help.aliyun.com/zh/functioncompute/fc-2-0/user-guide/)[高级功能](https://help.aliyun.com/zh/functioncompute/fc-2-0/user-guide/advanced-features/)[管理域名](https://help.aliyun.com/zh/functioncompute/fc-2-0/user-guide/manage-domain-names/)开启Web应用防火墙

# 开启Web应用防火墙

更新时间：2025-08-04 01:32:07
...
[上一篇：配置自定义域名](https://help.aliyun.com/zh/functioncompute/fc-2-0/user-guide/configure-a-custom-domain-name)[下一篇：配置重写策略（公测中）](https://help.aliyun.com/zh/functioncompute/fc-2-0/user-guide/configure-rewrite-policies)
...
1. 登录 [函数计算控制台](https://fcnext.console.aliyun.com/overview)，在左侧导航栏，选择**高级功能** \> **域名管理**。

2. 在顶部菜单栏，选择地域，然后在 **域名管理** 页面，单击 **添加自定义域名**。

3. 在 **添加自定义域名** 页面，填写 **域名**，配置项 **Web 应用防火墙** 选择 **启用**，然后单击 **创建**。

关于各配置项的说明，请参见 [自定义域名](https://help.aliyun.com/zh/functioncompute/fc-2-0/user-guide/configure-a-custom-domain-name#section-4yb-ztm-q9v "")。

![start-waf](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7149204761/p549201.png)

...
[首页](https://help.aliyun.com/) [大模型服务平台百炼](https://help.aliyun.com/zh/model-studio/)[应用广场](https://help.aliyun.com/zh/model-studio/application-gallery/)[官方应用-通义数据挖掘](https://help.aliyun.com/zh/model-studio/tongyi-docmining/)[API参考](https://help.aliyun.com/zh/model-studio/docmining-api-reference/)[API目录](https://help.aliyun.com/zh/model-studio/docmining-api-directory/)文档内容审核

# 文档内容审核

更新时间：2026-02-11 02:19:38
...
[上一篇：信息抽取](https://help.aliyun.com/zh/model-studio/document-information-extraction)[下一篇：打标分类](https://help.aliyun.com/zh/model-studio/document-tagging)
...
| --- | --- | --- | --- | --- |
| **名称** | **类型** | **必填** | **描述** | **示例值** |
| capabilityType | string | 是 | 能力类型<br>文档内容审核：CONTENT\_REVIEW | CONTENT\_REVIEW |
| userPrompt | string | 是 | 提示词 | 你是一名经验丰富的高级文档审核专家，精通风险识别、合规性检查、事实核查和专业沟通。你的审核标准极为严格，注重细节，并能提供具有建设性的修改建议。你的任务是针对提供的文档，进行一次全面、深入的审核。你需要识别文档中存在的各种问题，生成一份结构化的审核报告。 |

...
[首页](https://help.aliyun.com/) [大模型服务平台百炼](https://help.aliyun.com/zh/model-studio/)[权限管理](https://help.aliyun.com/zh/model-studio/application-permission-management/)权限管理

# 权限管理

更新时间：2026-02-11 02:01:54
...
[上一篇：最佳实践](https://help.aliyun.com/zh/model-studio/component-management)[下一篇：10分钟给网站添加AI助手](https://help.aliyun.com/zh/model-studio/add-an-ai-assistant-to-your-website-in-10-minutes)
...
| [OpenAPI 接口权限](https://help.aliyun.com/zh/model-studio/application-permission-management-overview#4adcb2854f9rv "") | 不支持 | 不支持 | 不支持 |
...
1. 若不使用 **默认业务空间**，需保证业务空间已经为特定模型开通了 [模型调用](https://help.aliyun.com/zh/model-studio/application-permission-management-overview#7e5a648ddattc "") 权限。（需要超级管理员操作）
...
1. 若不使用 **默认业务空间**，需保证业务空间已经为特定模型开通了 [模型调优（训练）](https://help.aliyun.com/zh/model-studio/application-permission-management-overview#c180b853793v3 "") 权限。（需要超级管理员操作）
...
1. 若不使用 **默认业务空间**，需保证业务空间为特定模型开通了 [模型调优（训练）](https://help.aliyun.com/zh/model-studio/application-permission-management-overview#c180b853793v3 "") 权限。（需要超级管理员操作）

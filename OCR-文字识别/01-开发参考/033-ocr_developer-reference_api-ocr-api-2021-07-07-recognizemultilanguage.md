...
![](https://img.alicdn.com/imgextra/i4/O1CN01tVz6Eh1eY0Lb3pUGZ_!!6000000003882-2-tps-640-368.png)
...
| 2 | 购买 [小语种识别资源包](https://common-buy.aliyun.com/?commodityCode=ocr_multilanguage_dp_cn&request=%7B%22ord_time%22:%221:Year%22,%22order_num%22:1,%22pack%22:%22ocr_multilanguage_dp_cn_20211103180438_0408%22,%22flowout_spec%22:%22500%22%7D)。本 API 会赠送免费额度，可使用免费额度测试。 |
...
| 相关能力 | - [云市场通用多语言识别。](https://market.aliyun.com/products/57124001/cmapi00040847.html?#sku=yuncode3484700001) |

## 调试

[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI\\
Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/api/ocr-api/2021-07-07/RecognizeMultiLanguage)

[![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png)调试](https://api.aliyun.com/api/ocr-api/2021-07-07/RecognizeMultiLanguage)
...
| 操作 | 访问级别 | 资源类型 | 条件关键字 | 关联操作 |
| --- | --- | --- | --- | --- |
| ocr:RecognizeMultiLanguage |  | \*全部资源<br>`*` | 无 | 无 |
...
| 名称 | 类型 | 必填 | 描述 | 示例值 |
| --- | --- | --- | --- | --- |
| Url | string | 否 | - 本字段和 body 字段二选一，不可同时透传或同时为空。<br>- 图片链接（长度不超 2048 字节，不支持 base64）。 | https://help-static-aliyun-doc.aliyuncs.com/file-manage-files/zh-CN/20241218/qshrcp/%E9%80%9A%E7%94%A8%E5%A4%9A%E8%AF%AD%E8%A8%80.png |
...
| Languages | array | 是 | - 支持语言列表。 |  |
|  | string | 是 | - chn：中文，eng：英文，ja：日文，lading：拉丁，kor：韩文，tai：泰文，rus：俄文，mys：马来文，idn：印尼文，viet：越南文，ukr：乌克兰文，tur：土耳其文，tamil：泰米尔文。<br>- 其中 **lading** 支持以下语言：葡萄牙语、意大利语、德语、法语、西班牙语。 | chn |
...
| Data | string | 返回数据 | {"content":"PACKING Shipper/Export Invoice No & Date STM TECHNOLOGY INC. 20140730- ST44 ","height":1753,"orgHeight":1753,"orgWidth":1240,"prism\_version":"1.0.9","prism\_wnum":71,"prism\_wordsInfo":\[{"angle":0,"direction":0,"height":33,"pos":\[{"x":348,"y":137},{"x":531,"y":135},{"x":532,"y":168},{"x":348,"y":170}\],"prob":99,"recClassify":1,"width":184,"word":"PACKING","x":348,"y":135}\],"width":1240} |
...
```css
{
  ...
  "Data": {
    "content": "PACKING  Shipper/Export   Invoice No & Date  STM TECHNOLOGY INC. 20140730- ST44 ",
    "height": 1753,
    "orgHeight": 1753,
    "orgWidth": 1240,
    "prism_version": "1.0.9",
...
| 变更时间 | 变更内容概要 | 操作 |
| --- | --- | --- |
| 2021-08-17 | OpenAPI 入参发生变更 | [查看变更详情](https://api.aliyun.com/document/ocr-api/2021-07-07/RecognizeMultiLanguage?updateTime=2021-08-17#workbench-doc-change-demo) |
...
[上一篇：RecognizeEduPaperStructed - 精细版结构化切题](https://help.aliyun.com/zh/ocr/developer-reference/api-ocr-api-2021-07-07-recognizeedupaperstructed)[下一篇：RecognizeEnglish - 英语作文识别](https://help.aliyun.com/zh/ocr/developer-reference/api-ocr-api-2021-07-07-recognizeenglish)
